...
export const ProblemSchema = z.object({
  ...
  detailedDescription: z.string().min(10, 'Detailed description must be at least 10 characters'),
  ...
  expectedTimeComplexity: z.string().min(1, 'Expected time complexity is required'),
  expectedSpaceComplexity: z.string().min(1, 'Expected space complexity is required'),
});
